...
/*
function pip() {
document.getElementsByClassName('td'+b1)[a1].style.background=drc;
document.getElementsByClassName('td'+2)[2].style.background=drc;
document.getElementsByClassName('td'+3)[3].style.background=drc;
document.getElementsByClassName('td'+1)[3].style.background=drc;
document.getElementsByClassName('td'+3)[t1].style.background=drc;


document.getElementsByClassName('td'+1)[5].style.background=drc;
document.getElementsByClassName('td'+2)[6].style.background=drc;
document.getElementsByClassName('td'+1)[7].style.background=drc;
document.getElementsByClassName('td'+3)[5].style.background=drc;
